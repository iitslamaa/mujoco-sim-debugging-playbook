...
earthmoving-plan-search:
	$(PYTHON) scripts/search_earthmoving_plan.py
...
robustness-sensitivity:
	$(PYTHON) scripts/generate_robustness_sensitivity.py
...
application-packet:
	$(PYTHON) scripts/generate_application_packet.py

application-bundle:
	$(PYTHON) scripts/generate_application_bundle.py

application-readiness:
	$(PYTHON) scripts/generate_application_readiness.py

application-stack:
	MPLCONFIGDIR=/tmp/mpl $(PYTHON) scripts/generate_application_stack.py

interview-assets:
	$(PYTHON) scripts/generate_interview_assets.py
...
terrain-kernel-benchmark:
	$(PYTHON) scripts/benchmark_terrain_kernel.py

rust-terrain-kernel-smoke:
	bash scripts/build_rust_terrain_kernel.sh

rust-terrain-kernel-benchmark:
	$(PYTHON) scripts/benchmark_rust_terrain_kernel.py

native-kernel-matrix:
	$(PYTHON) scripts/generate_native_kernel_matrix.py
