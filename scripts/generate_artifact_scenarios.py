...
from mujoco_sim_debugging_playbook.artifact_scenarios import write_artifact_scenarios


def main() -> None:
    output_dir = ROOT / "outputs" / "artifact_scenarios"
    payload = write_artifact_scenarios(
    ...
    print(f"Wrote artifact scenarios with {len(payload['scenarios'])} scenarios to {output_dir}")
