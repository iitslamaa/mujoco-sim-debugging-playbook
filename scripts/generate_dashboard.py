...
def main() -> None:
    ...
    dashboard_snapshot_actions = _read_json(ROOT / "outputs" / "dashboard_snapshots" / "actions.json")
    ...
    dashboard_snapshot_lead = _read_json(ROOT / "outputs" / "dashboard_snapshots" / "lead.json")
    ...
    payload = {
        ...
        "dashboard_snapshot_actions": dashboard_snapshot_actions,
        ...
        "dashboard_snapshot_lead": dashboard_snapshot_lead,
        "case_studies": {
        ...
        "artifacts": {
            ...
            "dashboard_snapshot_actions_markdown": "outputs/dashboard_snapshots/actions.md",
            ...
            "dashboard_snapshot_lead_markdown": "outputs/dashboard_snapshots/lead.md",
        },
    }
